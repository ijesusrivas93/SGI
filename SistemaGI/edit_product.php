 ...
 if(isset($_POST['product'])){
   ...
   if(empty($errors)){
      ...
      $p_sale  = remove_junk($db->escape($_POST['saleing-price']));
       ...
       $query  .=" reference ='{$p_ref}', quantity ='{$p_qty}',";
       $query  .=" features ='{$p_fea}', sale_price ='{$p_sale}', brand ='{$p_bra}', model='{$p_mod}'";
           ...
           <form method="post" action="edit_product.php?id=<?php echo (int)$product['id'] ?>">
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-reference" value="<?php echo remove_junk($product['reference']);?>">
               </div>
              </div>
              <div class="form-group">
                <div class="input-group">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-model" value="<?php echo remove_junk($product['model']);?>">
               </div>
              </div>
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-features" value="<?php echo remove_junk($product['features']);?>">
               </div>
              </div>
